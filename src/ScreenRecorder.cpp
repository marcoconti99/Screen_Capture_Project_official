...
//	value = avformat_find_stream_info(pAVFormatContext,NULL);
    ...
    AVCodec *pCodec = pLocalCodec;
    AVCodecContext *pCodecContext = avcodec_alloc_context3(pCodec);
    avcodec_parameters_to_context(pCodecContext, pLocalCodecParam);

	value = avcodec_open2(pCodecContext, pCodec , NULL);//Initialize the AVCodecContext to use the given AVCodec.
	if( value < 0 )
	{
